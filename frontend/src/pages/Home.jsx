            ...
            <div className="content">
                {project ? (
                    <div className="project-content">
                        ...
                        <label>UNIT*</label>
                        <input type="text" value={removeFileExtension(project.unit)} onChange={(e) => setProject({ ...project, unit: e.target.value })} />
                        <label>PPLX*</label>
                        <input type="text" value={removeFileExtension(project.pplx)} onChange={(e) => setProject({ ...project, pplx: e.target.value })} />
                        <label>TTRX*</label>
                        <input type="text" value={removeFileExtension(project.ttrx)} onChange={(e) => setProject({ ...project, ttrx: e.target.value })} />
                        <label>TERX*</label>
                        <input type="text" value={removeFileExtension(project.terx)} onChange={(e) => setProject({ ...project, terx: e.target.value })} />
                        <label>NEWSITEMS*</label>
                        <input type="text" value={removeFileExtension(project.newsitems)} onChange={(e) => setProject({ ...project, newsitems: e.target.value })} />
                        <label>PROFILE*</label>
                        <input type="text" value={removeFileExtension(project.profile)} onChange={(e) => setProject({ ...project, profile: e.target.value })} />

                        <h2>Editable Data Files</h2>
                        <label>CVP*</label>
                        <input type="text" value={removeFileExtension(project.cvp)} onChange={(e) => setProject({ ...project, cvp: e.target.value })} />
                        <label>WMData*</label>
                        <input type="text" value={removeFileExtension(project.wmdata)} onChange={(e) => setProject({ ...project, wmdata: e.target.value })} />
                        <label>OOB</label>
                        <input type="text" value={removeFileExtension(project.oob)} onChange={(e) => setProject({ ...project, oob: e.target.value })} />
