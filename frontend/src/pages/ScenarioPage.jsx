...
const ScenarioPage = ({ project, setProject }) => {
    ...
    // Update handleInputFieldChange function
                    ...
                    <div className="project-content">
                            ...
                            <div className="input-group">
                                ...
                                <div className="checkbox-under-input">
                                    <input
                                        type="checkbox"
                                        id="same-as-scenario"
                                        checked={getFilename('sav') === getFilename('scenario')}
                                        onChange={() => {
                            ...
                            <div className="input-group">
                                ...
                                <div className="checkbox-under-input">
                                    <input
                                        type="checkbox"
                                        id="same-as-map"
                                        checked={getFilename('oof') === getFilename('mapx')}
                                        onChange={() => {
                        ...
                        <div className="checkbox-group">
                            <input
                                ...
                                onChange={() => setUseDefaultFiles(!useDefaultFiles)}
                            />
